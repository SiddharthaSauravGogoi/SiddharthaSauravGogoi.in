  ...
  return (
    <div className="social-icons">
      ...
      <div className="linkedin">
        <a href="https://www.linkedin.com/in/siddhartha-saurav-gogoi/" target="_blank" rel="noopener noreferrer">
          <img className="icon" src="https://image.flaticon.com/icons/svg/69/69406.svg" alt="" />
        </a>
      </div>
